...
public class HelloInterceptor2 implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
			throws Exception {
		System.out.println("执行到了HelloInterceptor2中的preHandle");
	...
	//可以通过modelAndView参数来改变显示的视图，或发往视图 的参数
		public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
			...
			//设置发往视图的参数
			modelAndView.addObject("msg", "通过HelloInterceptor2拦截器将返回视图都转到了这个页面， this is HelloInterceptor1 msg");
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
			throws Exception {
		System.out.println("执行到了HelloInterceptor2中的afterCompletion");
